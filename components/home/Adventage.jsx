  ...
  return (
        <div className='flex h-max lg:h-[75%] flex-col lg:flex-row bg-white w-[90vw] lg:w-full mx-auto animate__animated animate__fadeIn transition duration-300 shadow-md'>
          <div className="w-full lg:w-2/5 p-2 lg:p-4"> 
            <div>
              <p className='text-end text-8xl lg:text-9xl font-bold text-[#F4F6F9]'>{`0${no}`}</p>
              <div className='w-[100%] lg:w-[78%] ms-auto'>
                <h3 className='text-3xl text-[#1266AA] mb-10'>{judul}</h3>
                <p className='mb-8 Lg:mb-20'>{description}...</p>
...
const Adventage = () => {
  ...
  return (
    <div className='bg-[#F6FAFE] h-[115vh] lg:h-[93vh] pt-20 ff'>
        <div className='flex flex-col h-[25%] lg:flex-row gap-4 lg:gap-0 justify-between w-[94%] lg:w-[80%] mx-auto'>
